...
expected_members = {
    ...
    "docs/EXPORT_INTEGRATIONS.md": ("file", 0o644),
    "docs/KERNEL_FILTERS.md": ("file", 0o644),
    "docs/RELEASING.md": ("file", 0o644),
    "docs/TCP_LIFECYCLE.md": ("file", 0o644),
    "docs/V2_DESIGN.md": ("file", 0o644),
    "examples/check_tcp_failures.py": ("file", 0o755),
    "examples/dns-observations.example.jsonl": ("file", 0o644),
    "examples/ndjson_to_csv.py": ("file", 0o755),
